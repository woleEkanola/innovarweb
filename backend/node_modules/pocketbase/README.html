...
<li><a href="#custom-fetch">Custom fetch</a></li>
...
<h3 id="custom-fetch">Custom fetch<a class="headerlink" href="#custom-fetch" title="Permanent link"></a></h3>
<p>Some frameworks, has their own custom local <code>fetch</code> implementation (eg. <a href="https://kit.svelte.dev/docs/load#making-fetch-requests">SvelteKit-making-fetch-requests</a>).
You can pass a custom local <code>fetch</code> function by using the special <code>$fetch</code> param:</p>
<div class="highlight"><pre><span class="c1">// SvelteKit load() example</span>
<span class="cm">/** @type {import(&#39;./$types&#39;).PageLoad} */</span>
<span class="kr">export</span> <span class="nx">async</span> <span class="kd">function</span> <span class="nx">load</span><span class="p">({</span> <span class="nx">fetch</span> <span class="p">})</span> <span class="p">{</span>
    <span class="kr">const</span> <span class="nx">item</span> <span class="o">=</span> <span class="nx">await</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s1">&#39;example&#39;</span><span class="p">).</span><span class="nx">getOne</span><span class="p">(</span><span class="s1">&#39;RECORD_ID&#39;</span><span class="p">,</span> <span class="p">{</span>
        <span class="s2">&quot;$fetch&quot;</span><span class="o">:</span> <span class="nx">fetch</span><span class="p">,</span>
    <span class="p">});</span>

    <span class="k">return</span> <span class="p">{</span> <span class="nx">item</span><span class="o">:</span> <span class="nx">item</span><span class="p">.</span><span class="kr">export</span><span class="p">()</span> <span class="p">};</span>
<span class="p">}</span>
</pre></div>

<h3 id="custom-headers">Custom headers<a class="headerlink" href="#custom-headers" title="Permanent link"></a></h3>
<p>Sometimes you may want to send a custom <code>Authorization</code> token or any other custom header alongside your request.
You can do that globally using the <code>pb.beforeSend</code> hook OR individually for each request by using the special <code>$headers</code> param:</p>
<div class="highlight"><pre><span class="kr">const</span> <span class="nx">item</span> <span class="o">=</span> <span class="nx">await</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s1">&#39;example&#39;</span><span class="p">).</span><span class="nx">getOne</span><span class="p">(</span><span class="s1">&#39;RECORD_ID&#39;</span><span class="p">,</span> <span class="p">{</span>
    <span class="s2">&quot;$headers&quot;</span><span class="o">:</span> <span class="p">{</span>
        <span class="s2">&quot;Authorization&quot;</span><span class="o">:</span>   <span class="s2">&quot;YOUR_CUSTOM_TOKEN&quot;</span><span class="p">,</span>
        <span class="s2">&quot;X-Custom-Header&quot;</span><span class="o">:</span> <span class="s2">&quot;YOUR_CUSTOM_HEADER&quot;</span><span class="p">,</span>
    <span class="p">},</span>
<span class="p">});</span>
</pre></div>
